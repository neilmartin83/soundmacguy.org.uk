---
layout: post
title: "The Adobe User Sync Tool - I've got that \"syncing\" feeling"
date: 2019-02-21
coverImage: "dzeik3lx0aazl0w.jpg"
---

At last week's [London Apple Admins](http://www.londonappleadmins.org.uk/) meet-up, I spoke about how to get started with the [Adobe User Sync Tool](https://github.com/adobe-apiplatform/user-sync.py) (UST). Thanks again to [Steve](https://blog.quirke.org/) and [ThoughtWorks](https://www.thoughtworks.com) for hosting us and [dataJAR](https://datajar.co.uk/) for the delicious food and drink!
...
[**Click here for the slides!**](https://drive.google.com/open?id=1ervD9M5ejpbqFqFE1kc0L87EGpJWkJB4)
...
- [Adobe - Set up Identity](https://helpx.adobe.com/enterprise/using/set-up-identity.html)
- [Adobe UMAPI Documentation](https://adobe-apiplatform.github.io/umapi-documentation/en/)
- [Adobe Shared Device Licensing Deployment Guide](https://helpx.adobe.com/enterprise/using/sdl-deployment-guide.html)
...
- [Me - Shared Device Licensing - My FAQ](https://soundmacguy.wordpress.com/2019/02/01/adobe-shared-device-licensing-answers-to-questions-you-probably-didnt-want-to-ask/)
